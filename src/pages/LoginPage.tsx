...
const LoginPage = ({ onLogin }: LoginPageProps) => {
  ...
  return (
    <div className="flex min-h-[100dvh] flex-col items-center justify-center bg-gradient-to-b from-background to-muted px-4 sm:px-6 overflow-hidden">
      ...
      <Card className="w-full max-w-md max-h-[calc(100dvh-8rem)] rounded-[24px] border-none bg-card/90 p-4 sm:p-8 shadow-xl backdrop-blur overflow-y-auto overscroll-contain">
      ...
      <Dialog
        ...
        modal={true}
      >
        <DialogContent className="top-0 translate-y-0 left-0 translate-x-0 w-screen h-[100dvh] max-h-[100dvh] rounded-none overflow-y-auto p-4 sm:p-6 sm:left-[50%] sm:top-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:w-full sm:h-auto sm:max-w-md sm:max-h-[90vh] sm:rounded-[24px]">
          <DialogHeader>
